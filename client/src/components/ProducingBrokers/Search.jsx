                ...
                <Grid sx={{flexGrow: 1}} container spacing={0.5}>
                    <Grid item xs={5}>
                        ...
                        <SearchInput
                            ...
                            error={errorStyle}
                        />  
                        {errorStyle && <Typography variant='caption' color={"error.main"} >Must be at least 3 characters</Typography>}
                        </Stack>
                        
                    </Grid>
                    <Grid sx={{mt: 1}} item xs={2}>
                        <SearchButton sx={{ml: 1}} loading={loading} onClick={showRows}>Search</SearchButton>
                    </Grid>
                </Grid>
            </Paper>
    );
